  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center">
        <h5 className="info-title text-base font-semibold text-left flex items-center text-white">
          <MdOutlineBarChart className="mr-2" />
          Leave Applications
        </h5>
        {/* View All button in the top-right corner, aligned with the title */}
        <a
      ...
      <div className="absolute bottom-4 right-4 flex flex-col items-center">
        ...
        {/* Text below button */}
        <span className="text-[#d0e567] text-sm mt-2">
          New Application
        </span>
      </div>
    </div>
