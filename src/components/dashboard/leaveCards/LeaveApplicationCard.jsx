...
const LeaveApplicationCard = ({ openApps, pendingApps, approvedApps, onViewAll, onNewApp }) => {
  const data = [
  ...
  return (
    <div className="relative card-class bg-[#292929] rounded-lg shadow-lg p-6 flex flex-col" style={{ fontFamily: "'Poppins', sans-serif" }}>
        ...
        {/* Values for Open, Pending, Approved */}
          <div className="ml-4 text-left text-white">
            <div className="text-sm flex items-center">
              <MdCheck className="mr-2 align-middle" style={{ fontSize: '1rem' }} /> {/* Open icon */}
              Open: {openApps}
            </div>
            <div className="text-sm flex items-center">
              <MdCheck className="mr-2 align-middle" style={{ fontSize: '1rem' }} /> {/* Pending icon */}
              Pending: {pendingApps}
            </div>
            <div className="text-sm flex items-center">
              <MdCheck className="mr-2 align-middle" style={{ fontSize: '1rem' }} /> {/* Approved icon */}
      ...
      <div className="absolute bottom-4 right-4 flex flex-col items-center">
        ...
        {/* Text below button */}
        <span className="text-[#d0e567] hover:bg-[#484848] text-sm mt-2">New Application</span>
      </div>
    </div>
  );
};
